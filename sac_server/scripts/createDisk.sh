...
then
	...
	echo ""
	echo "		For example: ./createDisk 100 sac-server.bin"
	echo ""
	echo "	This means that by default, this script will create and format with SAC a 10MB disk, named disk.bin"
	echo ""
